...
|------|------------|------------------------|-----------|--------------------------------|-----------|
| **Free Tier** | **$0** | **15 RPM / 1,000 RPD** | **$0** | - | Tier 1~2 기본 Markdown 변환, 파일 Bypass (307 Redirect) |
| **Pro Agent** | **$20 USDC** | **12,000회** | **$0.00166** (약 2.1원) | **3.5%** | Tier 3 JS 렌더링, **OpenAPI/Swagger 90% 압축**, Advanced Extraction, 요약 |
